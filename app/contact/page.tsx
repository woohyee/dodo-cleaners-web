        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="space-y-6">
            <div className="flex items-start space-x-3">
              <MapPin className="flex-shrink-0 mt-1 text-uber-black" size={20} />
              <p className="text-sm md:text-base text-uber-black">
                2500 Appleby Line Unit E1, Burlington, ON L7L 0A2
              </p>
            </div>
            <div className="flex items-center space-x-3">
              <Phone className="flex-shrink-0 text-uber-black" size={20} />
              <p className="text-sm md:text-base text-uber-black">
                905-315-9995
              </p>
            </div>
            <div className="flex items-start space-x-3">
              <Clock className="flex-shrink-0 mt-1 text-uber-black" size={20} />
              <div className="space-y-1 text-sm md:text-base text-uber-black">
          ...
          <div className="w-full h-[350px] relative overflow-hidden rounded-lg shadow-uber-card">
            <iframe
